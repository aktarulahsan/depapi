...
import com.aktarulahsan.erp.hrm.designation.DesignationModel;
...
@Repository
@Transactional
public class DepartmentRepository  extends BaseRepository implements CommonMethod {
    ...
    public Response findById(String regObj) {
        ...
        model.setDepartment_code(regObj);
    ...
    private CriteriaQuery criteriaQuery(DepartmentModel filter) {
        init();
    ...
    private List<Predicate> criteriaCondition(DepartmentModel filter, CriteriaBuilder builder, Root<DepartmentModel> root) {
...
//
    ...
    private void init() {
        initEntityManagerBuilderCriteriaQueryRoot(DepartmentModel.class);
